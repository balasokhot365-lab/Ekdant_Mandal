...
export const ReceiptModal: React.FC<ReceiptModalProps> = ({
  ...
  const handleWhatsAppShare = async () => {
    ...
    try {
      ...
      const fileName = `ekdant-mandel-2026_${receipt.receiptNo}.pdf`;
...
_श्री एकदंत मित्र मंडळ, उचगाव, कोल्हापूर  (26/2012)_ 🙏`;
        ...
        try {
          ...
          if (navigator.canShare({ files: [file] })) {
            await navigator.share({
              title: `श्री एकदंत मित्र मंडळ पावती क्र. ${receipt.receiptNo}`,
              text: waText,
              files: [file],
            });
            sharedDirectly = true;
