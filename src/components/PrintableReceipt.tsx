...
export const PrintableReceipt: React.FC<PrintableReceiptProps> = ({
  ...
  const [mandalInfo, setMandalInfo] = useState<IMandalInfo>({
    mandalName: "श्री एकदंत मित्र मंडळ",
    regNo: "26/2012",
    location: "पद्मावती मळा,उचगाव, कोल्हापूर , सातारा",
    mainAdminName: propMainAdminName || "आनंद नाईक",
    mainAdminMobile: "8149703310",
    ...
    >
      ...
      >
        ...
        <div className="text-center px-1 flex-1 min-w-0">
          ...
          >
            {/* {mandalInfo.location} */}
            पद्मावती मळा,उचगाव, कोल्हापूर , सातारा
          </p>
          <div
            style={{
