...
export const translations = {
  mr: {
    ...
    mandalName: "श्री एकदंत मित्र मंडळ, उचगाव, कोल्हापूर ",
    mandalTagline: "॥ श्री गणेशाय नमः ॥ सार्वजनिक गणेशोत्सव उत्सव",
    mandalLocation: "उचगाव, कोल्हापूर)",
    regNo: "नोंदणी क्र. 26/2012",
    ...
    loginSubtitle: "श्री एकदंत मित्र मंडळ, उचगाव, कोल्हापूर  गणेशोत्सव प्रणाली",
    mobileLabel: "नोंदणीकृत मोबाईल नंबर",
    passwordLabel: "पासवर्ड",
    loginBtn: "लॉगिन करा",
    mainAdminQuickFill: "मुख्य अध्यक्ष लॉगिन (8149703310)",
    singleDeviceNotice: "सुरक्षा सूचना: एकाच वेळी फक्त एकाच डिव्हाइसवर लॉगिन चालू राहील.",

    // Receipt Print Header & Text
    receiptHeaderMandal: "श्री एकदंत मित्र मंडळ",
    receiptHeaderSub: "सिद्धिविनायक कॉलनी, मनेरमळा, उचगाव, कोल्हापूर",
  ...
  en: {
    // App Header & Mandal Info
    mandalName: "Ekdant Mitra Mandal Uchgaon",
    ...
    loginSubtitle: "Ekdant Mitra Mandal UchgaonSystem",
    mobileLabel: "Registered Mobile Number",
    passwordLabel: "Password",
    loginBtn: "Login",
    mainAdminQuickFill: "Main Admin Login (8149703310)",
