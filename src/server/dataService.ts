...
export function getMandalConfig() {
  return {
    mandalId: process.env.MANDAL_ID || "ekdant-mandel-2026",
    mandalName: process.env.MANDAL_NAME || "श्री एकदंत मित्र मंडळ",
    mandalPrefix: process.env.MANDAL_PREFIX || "EMM",
    mandalRegNo: process.env.MANDAL_REG_NO || "महा./१८५/२०२३",
    mandalLocation:
      process.env.MANDAL_LOCATION || "पद्मावती मळा,उचगाव, कोल्हापूर , सातारा",
    mainAdminName: process.env.MAIN_ADMIN_NAME || "आनंद नाईक",
    mainAdminMobile: process.env.MAIN_ADMIN_MOBILE || "8149703310",
    mainAdminPassword: process.env.MAIN_ADMIN_PASSWORD || "Anand@8149",
